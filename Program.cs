...
namespace GremlinNetSample
{
    ...
    class Program
    {
        ...
        private static string hostname = "webappmyweb-server.gremlin.cosmosdb.azure.com";
        private static int port = 443;
        private static string authKey = "NsBThLlEMztnTlczydVV2RtXKQRNIZ93tpxGJXx7Q8jc0OFRuzVZSODgdi6WMoyda68lFvhRzv7mACDbnBwJQg==";
